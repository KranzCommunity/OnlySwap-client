...
import { PancakeswapPair, PancakeswapPairSettings, BNB, RouteQuote } from 'simple-bakeryswap-sdk';

@Injectable({
  providedIn: 'root'
})
export class BakeryswapServiceService {
